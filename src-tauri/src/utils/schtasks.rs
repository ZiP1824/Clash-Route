...
const TASK_NAME_USER: &str = "Clash Verge Route";
const TASK_NAME_ADMIN: &str = "Clash Verge Route (Admin)";
const TASK_XML_DIR: &str = "tasks";
const TASK_XML_USER: &str = "clash-verge-route-task-user.xml";
const TASK_XML_ADMIN: &str = "clash-verge-route-task-admin.xml";
...
async fn cleanup_legacy_shortcuts() -> Result<()> {
    ...
    let new_shortcut = startup_dir.join("Clash Verge Route.lnk");
