...
const TASK_NAME_USER: &str = "Clash Verge Smart";
const TASK_NAME_ADMIN: &str = "Clash Verge Smart (Admin)";
const TASK_XML_DIR: &str = "tasks";
const TASK_XML_USER: &str = "clash-verge-smart-task-user.xml";
const TASK_XML_ADMIN: &str = "clash-verge-smart-task-admin.xml";
...
async fn cleanup_legacy_shortcuts() -> Result<()> {
    ...
    let old_shortcut = startup_dir.join("Clash-Verge-Smart.lnk");
    let new_shortcut = startup_dir.join("Clash Verge Smart.lnk");
